...
// CONCATENATED MODULE: ./src/components/Storage.vue?vue&type=template&id=53bb13ce&shadow
...
/* harmony default export */ var Storagevue_type_script_lang_js_shadow = ({
  ...
  created() {
    this.storage = this.$store.state.storage.storage; //  this.$route.query.path != undefined ? this.updateFolder(this.$route.query.path) : ""
  },
